...
<!-- End Of  Validate Form Script -->
    ...
    <body>
        <div id="content">
            <div id="wrapper">
                <h2>Soal Isian Singkat (Essay)</h2></br></br>
		<h3></h3></br>
			<h3>Nama Soal Pilihan Essay		:</h3>	
			<form method="post" action="tambahsoal.php">
			<input type="text" name="kuis" value="" placeholder="Masukkan Nama Kuis"></br></br>
				...
				?>
			<table border="1">
			<h3>Masukkan soal essay pada kotak yang tersedia di bawah ini</h3>
