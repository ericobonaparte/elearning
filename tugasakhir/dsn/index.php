          ...
          <!--<a>Waktu :
            ...
            <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                    <h1>Lecturer Page @  E-learning System ITS</h1>
                              
                <section class="ib-container" id="ib-container">
				<!--<header><article>
			    		
						<h3><a href="/tugasakhir/dsn/matkul/">Manajemen Mata Kuliah</a></h3>
						<span>May 28, 2013 by Emerson Eridiansyah Zayin</span>
					</header>
					<p>Halaman bagi Dosen untuk melakukan manajemen mata kuliah dalam sistem E-Learning ITS</p>
				</article>-->
				<article>
			    		<header>
						<h3><a href="/tugasakhir/dsn/enroll/">Enroll Mahasiswa</a></h3>
						<span>May 28, 2013 by Emerson Eridiansyah Zayin</span>
					</header>
					<p>Halaman bagi Dosen untuk melakukan manajemen mata kuliah dalam sistem E-Learning ITS</p>
				</article>
				<article>
			    		<header>
						<h3><a href="/tugasakhir/dsn/kuis/">Interactive Quiz</a></h3>
						<span>May 28, 2013 by Emerson Eridiansyah Zayin</span>
					</header>
					<p>Halaman bagi Dosen untuk melakukan manajemen mata kuliah dalam sistem E-Learning ITS</p>
				</article>
				<article>
			    	<header>
						<h3><a href="/demo/demo3.jsp">Video Conference</a></h3>
						<span>May 28, 2013 by Emerson Eridiansyah Zayin</span>
					</header>
