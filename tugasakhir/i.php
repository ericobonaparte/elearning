...
<html lang="en">
  <head>
    ...
    <link href="/newcss/bootstrap-responsive.min.css" rel="stylesheet">
    <link href="/newcss/css/font-awesome.min.css" rel="stylesheet">
    <link href="/newcss/bootswatch.css" rel="stylesheet">
      ...
      <div class="well" style="padding: 25px 25px 15px 25px;">
        <a href="http://www.maxcdn.com" target="_blank">
          <span style="float: left; margin: 0 15px 10px 0;">
            <img src="../img/maxcdn.gif" width="175" height="135">
          </span>
        </a>
        <a href="http://www.maxcdn.com" target="_blank">
